...
## Analísis
La gráfica vista anteriormente corresponde a la señal de respuesta galvánica de la piel (GSR) registrada durante el experimento, donde se comparan la señal cruda adquirida directamente del sensor y la señal filtrada obtenida mediante procesamiento digital. Desde una perspectiva de instrumentación biomédica, esta representación permite analizar cómo un fenómeno fisiológico —la actividad sudomotora controlada por el sistema nervioso simpático— se traduce en una señal eléctrica medible. La señal cruda refleja las variaciones instantáneas de voltaje asociadas a cambios en la conductancia de la piel; sin embargo, también incorpora ruido proveniente de diversas fuentes, como interferencias electromagnéticas del entorno, micro-movimientos del sujeto, variaciones en la impedancia de contacto entre los electrodos y la piel, así como pequeñas fluctuaciones propias del circuito de adquisición. Estas perturbaciones son comunes en la medición de biopotenciales o bioimpedancias, ya que el sistema de medición interactúa directamente con el cuerpo humano, que forma parte del circuito eléctrico.

La aplicación del filtro digital pasa-bajo de aproximadamente 1 Hz permite observar de manera más clara la dinámica fisiológica real de la señal. La actividad electrodérmica es una señal de baja frecuencia, debido a que los procesos fisiológicos que la generan —principalmente la secreción de sudor en las glándulas ecrinas— ocurren de forma relativamente lenta en comparación con otras señales biomédicas como el electrocardiograma o la electromiografía. Por esta razón, al eliminar las componentes de alta frecuencia mediante filtrado digital se obtiene una señal más suave y continua que permite identificar el comportamiento del sistema fisiológico subyacente. En la señal filtrada se observa una tendencia basal que corresponde al Skin Conductance Level (SCL), el cual representa el nivel tónico de conductancia de la piel y está relacionado con el estado general de activación del sistema nervioso autónomo del individuo.

Sobre este nivel basal pueden presentarse pequeñas variaciones transitorias que corresponden a respuestas fásicas de conductancia cutánea (SCR). Estas respuestas suelen generarse ante estímulos fisiológicos, emocionales o cognitivos que provocan activación simpática. Cuando el sistema nervioso simpático se activa, aumenta la actividad de las glándulas sudoríparas ecrinas ubicadas principalmente en las palmas de las manos y en las yemas de los dedos. La secreción de sudor incrementa la hidratación de la capa córnea de la piel y disminuye su resistencia eléctrica, lo que produce un aumento en la conductancia cutánea que puede detectarse mediante el sensor GSR. En la gráfica, estos cambios se reflejan como incrementos graduales o picos suaves en la señal filtrada, seguidos por un retorno progresivo al nivel basal debido a los mecanismos de regulación fisiológica del organismo.

Otro aspecto relevante desde el punto de vista biomédico es la diferencia entre la señal cruda y la señal filtrada en términos de interpretabilidad clínica o experimental. La señal cruda, aunque contiene toda la información original del sistema, presenta una alta variabilidad que dificulta la identificación directa de patrones fisiológicos. El procesamiento digital, en este caso mediante filtrado, actúa como una etapa fundamental dentro de la cadena de instrumentación biomédica, permitiendo separar la información fisiológica relevante del ruido instrumental. Este proceso demuestra cómo el diseño de sistemas de adquisición biomédica no se limita únicamente a la captación de señales, sino que también incluye etapas de acondicionamiento analógico y procesamiento digital que permiten obtener datos confiables para su análisis.

Además, la gráfica permite evidenciar la relación entre los parámetros del sistema de adquisición y la naturaleza de la señal fisiológica. La frecuencia de muestreo utilizada en el experimento es suficiente para capturar la dinámica temporal de la señal GSR, ya que el contenido espectral relevante se encuentra por debajo de 1 Hz. Esto muestra la importancia de seleccionar adecuadamente los parámetros de adquisición en función de la fisiología del fenómeno que se desea estudiar. Una frecuencia de muestreo demasiado baja podría perder información relevante, mientras que una excesivamente alta generaría un volumen de datos innecesario sin aportar mejoras significativas en la calidad de la señal.

En conjunto, la gráfica demuestra cómo la respuesta galvánica de la piel constituye un indicador fisiológico indirecto de la actividad del sistema nervioso autónomo. A través de la medición de la conductancia cutánea es posible inferir cambios en el estado de activación del organismo, lo que hace que esta señal sea ampliamente utilizada en estudios de psicofisiología, investigación del estrés, análisis de carga cognitiva y desarrollo de interfaces fisiológicas. Desde la perspectiva de la ingeniería biomédica, el experimento permite comprender cómo fenómenos biológicos complejos pueden ser convertidos en señales eléctricas medibles mediante sensores, circuitos electrónicos y técnicas de procesamiento digital.

## Conclusiones 

La práctica permitió comprender de manera aplicada cómo la actividad fisiológica del sistema nervioso autónomo puede medirse mediante la respuesta galvánica de la piel, evidenciando la relación entre la secreción sudorípara, la conductancia eléctrica cutánea y la activación simpática del organismo. A través del proceso de adquisición, filtrado y visualización de la señal GSR se aprendió la importancia del diseño adecuado de sistemas de instrumentación biomédica, incluyendo la correcta selección de sensores, parámetros de muestreo y técnicas de procesamiento de señales para obtener mediciones confiables. Esta experiencia no solo permitió interpretar el comportamiento fisiológico reflejado en la señal, sino que también fortaleció la comprensión de cómo integrar conocimientos de fisiología, electrónica y análisis de señales en la medición de variables biomédicas. A futuro, estos conceptos resultan fundamentales para el desarrollo y análisis de dispositivos biomédicos orientados al monitoreo fisiológico, la evaluación del estrés, el estudio de la respuesta emocional y la implementación de sistemas de biofeedback o interfaces humano-máquina basadas en señales fisiológicas.
